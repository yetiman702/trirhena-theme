...
class Walker_Nav_Menu_Counter extends Walker_Nav_Menu
{
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) 
	{
		...
		if( $this->firstrun )
		{
			$this->n = wp_nav_menu( array(
				...
				'walker'					=> new Walker_Nav_Menu_Counter()
			) );
		}
		//var_dump( $this->n );
		$this->firstrun = false;
		//var_dump( $this->n );
		//$n != 0 ? $width = 100/$n; : $n=25;
